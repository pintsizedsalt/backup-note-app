...
<nav class="drawer">
        <ul>
            ...
            <li>
                <a href="{{ route('showBookmarkedNotes') }}" class="nav-link.active nav" id="bold">
...
<main class="container">
    ...
    @else
        <section class="notes-list1">
            ...
            <a href="{{ route('showBookmarkedNote', ['id' => $note->id, 'from' => 'bookmarked']) }}" class="card" style="text-decoration: none; color: inherit;">
                    <div class="text">
